// drf5n 2021-12-07  
// Forked from https://github.com/pedvide/ADC/blob/master/examples/analogContinuousRead/analogContinuousRead.ino
//
...
*  Write d to see the data recorded during the burst
*/
...
void setup() {
    ...
    adc->adc0->setConversionSpeed(ADC_CONVERSION_SPEED::VERY_MED_SPEED); // change the conversion speed
...
void adc0_isr(void) { // Triggered at each completion
    ...
    if(digitalReadFast(pulsePin) && micros() >= pulseEnd){
